...
public class FolderWorkbenchLabelProvider extends LabelProvider
	...
	*   new <code>WorkbenchLabelProvider</code>
	...
	private IPropertyListener editorRegistryListener = new IPropertyListener() {
		...
		public void propertyChanged(Object source, int propId) {
			if (propId == IEditorRegistry.PROP_CONTENTS) {
				fireLabelProviderChanged(new LabelProviderChangedEvent(FolderWorkbenchLabelProvider.this));
			}
		}
	};
	 ...
	 */
	public FolderWorkbenchLabelProvider() {
